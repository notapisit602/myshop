<form action="" method="get" class="from-horizontal">
    <h4>เลือกช่วงวันที่ในการเรียกดูยอดขาย</h4>
    <div class="from-group">
        <div class="col-sm-1 control-lable">
    Start
        </div>
    <div class="col-sm-3">
    ...
    <div class="col-sm-1">
      <button type="subumit" name="act" value="show-date" class="btn btn-primary">ค้นหา</button>
    </div>
  </div>
</from>
...
AND order_date BETWEEN '$ds 00:00:00.000000' AND '$de 23:59:59.000000'
