...
<?php do { ?>
  <div class="col-sm-6" align="center">
     <a href="product-detail.php?p_id=<?php echo $row_prd['p_id'];?>&act=product-detail" target="_blank">
    <img src="pimg/<?php echo $row_prd['p_img1'];?>" width="100%"/>
  </a> 
    <p align="center">
      <b><?php echo $row_prd['p_name']; ?>
        <br />
       <font color="red">  
