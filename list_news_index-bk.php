...
?>
<?php // include('h.php');?>
          <table id="example1" class="table table-hover" cellspacing="0" border="1">
		<thead>
            <tr class="success">
            ...
            <?php $i=1; do { ?>
              <tr>
                ...
                <td>
                <b>
				 <a href="news.php?n_id=<?php echo $row_listnews['n_id'];?>&news-detail" target="_blank"> <?php echo $row_listnews['n_title']; ?>
